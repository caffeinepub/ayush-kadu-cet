...
function Navbar({ theme, onNavigate, active }) {
  const links = [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "nav",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden md:flex gap-6", children: links.map((l) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
...
function HomePage({ theme, onNavigate, onStartTest }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative min-h-screen", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { position: "relative", zIndex: 1 }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Navbar, { theme, onNavigate, active: "home" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-6xl mx-auto px-6 py-24", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-2 gap-12 items-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: "🔥 India's Smartest CET Prep Platform"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "h1",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-lg mb-8", style: { color: "#AAB3C5" }, children: [
            "PYQ-powered mock tests. 2020–2025 analysis. Subject-wise preparation with personalized feedback.",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { style: { color: "#F4F7FF" }, children: "Completely free." })
          ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-6xl mx-auto px-6 pb-12", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-4", children: [
        ...
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm", style: { color: "#AAB3C5" }, children: s.label })
          ]
        },
        s.label
      )) }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-6 pb-24", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl font-black mb-8", style: { color: "#F4F7FF" }, children: "Subject-wise Mock Tests" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-3 gap-6", children: subjects.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm mb-4", style: { color: "#AAB3C5" }, children: s.desc }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "⏱ 2020–2025" })
                  ]
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
...
const questions = [
  // ===== MATHS =====
  {
    ...
    correctIndex: 0,
    explanation: "The standard integral ∫1/(1+x²)dx = tan⁻¹x + C is a fundamental formula.",
    improvementTip: "Memorize all 6 inverse trig integrals. Write them daily for a week. Focus on ∫1/(1+x²), ∫1/√(1-x²), ∫1/(x√(x²-1))."
  },
  {
    id: 2,
    subject: "Maths",
    ...
    correctIndex: 0,
    explanation: "Using integration by parts: ∫x·eˣdx = x·eˣ - ∫eˣdx = xeˣ - eˣ + C = eˣ(x-1) + C.",
    improvementTip: "Practice ILATE rule for integration by parts: Inverse trig → Log → Algebraic → Trig → Exponential. Solve 15 IBP problems."
  },
  {
    id: 3,
    subject: "Maths",
    ...
    correctIndex: 0,
    explanation: "Use identity: sin²x = (1-cos2x)/2. So ∫sin²x dx = ∫(1-cos2x)/2 dx = x/2 - sin2x/4 + C.",
    improvementTip: "Learn trig identities for integration: sin²x=(1-cos2x)/2, cos²x=(1+cos2x)/2. These appear every year."
  },
  {
    id: 4,
    subject: "Maths",
    ...
    improvementTip: "Master addition theorem of probability. Always use P(A∪B) = P(A)+P(B)-P(A∩B). Draw Venn diagrams to visualize."
  },
  {
    id: 5,
    subject: "Maths",
    ...
    improvementTip: "Practice dice problems by listing all sample space outcomes. The sum 7 with two dice is the most frequent — 6 ways out of 36."
  },
  {
    id: 6,
    subject: "Maths",
    ...
    improvementTip: "Practice 2×2 and 3×3 determinants daily. For 2×2: ad-bc. For 3×3 use cofactor expansion. Do 10 problems per day."
  },
  {
    id: 7,
    subject: "Maths",
    ...
    improvementTip: "Matrix inverse formula: A⁻¹ = (1/det(A))·adj(A). First find det, then swap diagonals and negate off-diagonals for 2×2."
  },
  {
    id: 8,
    subject: "Maths",
    ...
    correctIndex: 3,
    explanation: "|a| = √(4+9+36) = √49 = 7. Both A and C are correct (7 = √49).",
    improvementTip: "Magnitude of vector formula: |a| = √(x²+y²+z²). Practice with 3D vectors every day before the exam."
  },
  {
    id: 9,
    subject: "Maths",
    ...
    correctIndex: 0,
    explanation: "Dot product = 0 means cos θ = 0, so θ = 90°, meaning the vectors are perpendicular.",
    improvementTip: "Remember: dot product = 0 → perpendicular; cross product = 0 → parallel. These properties appear frequently in MHT-CET."
  },
  {
    id: 10,
    subject: "Maths",
    ...
    year: 2024,
    difficulty: "Medium",
    question: "Direction cosines of the line making equal angles with coordinate axes are:",
    options: ["(1/√3, 1/√3, 1/√3)", "(1,1,1)", "(1/3,1/3,1/3)", "(√3,√3,√3)"],
    correctIndex: 0,
    explanation: "If line makes equal angles, l=m=n. Using l²+m²+n²=1 → 3l²=1 → l=1/√3. So (1/√3,1/√3,1/√3).",
    improvementTip: "Key identity for direction cosines: l²+m²+n²=1 always. Use this to find unknown direction cosines."
  },
  {
    id: 11,
    subject: "Maths",
    ...
    improvementTip: "Order = highest derivative, Degree = power of highest derivative (when no fractional powers). Practice identifying these."
  },
  {
    id: 12,
    subject: "Maths",
    ...
    correctIndex: 0,
    explanation: "This is a standard limit. lim(x→0) sinx/x = 1 (x in radians).",
    improvementTip: "Memorize standard limits: sinx/x=1, tanx/x=1, (eˣ-1)/x=1, (aˣ-1)/x=lna as x→0. These repeat every year."
  },
  {
    id: 13,
    subject: "Maths",
    ...
    options: ["e", "1", "0", "∞"],
    correctIndex: 0,
    explanation: "This is the definition of e. lim(x→0)(1+x)^(1/x) = e ≈ 2.718.",
    improvementTip: "Key limit: lim(x→0)(1+x)^(1/x) = e. Also lim(n→∞)(1+1/n)ⁿ = e. These are favorite MHT-CET questions."
  },
  {
    id: 14,
    subject: "Maths",
    ...
    improvementTip: "Modulus of complex number: |a+bi| = √(a²+b²). The 3-4-5 Pythagorean triple appears very often in CET complex number problems."
  },
  {
    id: 15,
    subject: "Maths",
    ...
    improvementTip: "Remember eccentricity values: Circle=0, Ellipse=0 to 1, Parabola=1, Hyperbola>1. Draw and label all four conics."
  },
  {
    id: 16,
    subject: "Maths",
    ...
    improvementTip: "eˣ is its own integral and derivative. This is a fundamental property. Never forget it."
  },
  {
    id: 17,
    subject: "Maths",
    ...
    correctIndex: 0,
    explanation: "Bayes' theorem: P(A|B) = P(B|A)·P(A)/P(B). It gives posterior (updated) probability.",
    improvementTip: "Practice Bayes' theorem word problems. Identify prior, likelihood, and posterior. Solve 10 such problems from 2019-2024 papers."
  },
  {
    id: 18,
    subject: "Maths",
    ...
    improvementTip: "3D distance formula: √((x₂-x₁)²+(y₂-y₁)²+(z₂-z₁)²). Memorize it cold. It appears in every paper."
  },
  {
    id: 19,
    subject: "Maths",
    ...
    correctIndex: 0,
    explanation: "A symmetric matrix satisfies Aᵀ = A (transpose equals original). Skew-symmetric: Aᵀ = -A.",
    improvementTip: "Know matrix types: Symmetric(Aᵀ=A), Skew-symmetric(Aᵀ=-A), Orthogonal(AᵀA=I), Idempotent(A²=A). These definitions are tested directly."
  },
  {
    id: 20,
    subject: "Maths",
    ...
    correctIndex: 0,
    explanation: "Separating: dy/y = dx → ln|y| = x + k → y = Ceˣ where C = eᵏ.",
    improvementTip: "Variable separable method: bring all y terms one side, all x terms other side, then integrate both sides. Practice 15 variable separable DEs."
  },
  // ===== PHYSICS =====
  {
    id: 21,
    ...
    correctIndex: 0,
    explanation: "For a solid sphere about diameter: I = (2/5)MR². This is a standard result.",
    improvementTip: "Memorize all MI formulas: solid sphere=(2/5)MR², hollow sphere=(2/3)MR², disk=(1/2)MR², ring=MR², rod=ML²/12. Make a table and revise daily."
  },
  {
    id: 22,
    subject: "Physics",
    ...
    year: 2023,
    difficulty: "Hard",
    question: "A body rolls without slipping. The ratio of translational KE to total KE for a solid cylinder is:",
    options: ["2/3", "1/2", "3/4", "2/5"],
    correctIndex: 0,
    explanation: "KE_trans/KE_total = 1/(1+k²/R²). For solid cylinder k²/R²=1/2, so ratio = 1/(3/2) = 2/3.",
    improvementTip: "Rolling motion: total KE = (1/2)mv²(1+k²/R²). Memorize k²/R² for each body: solid sphere=2/5, solid cylinder=1/2, ring=1."
  },
  {
    id: 23,
    subject: "Physics",
    ...
    correctIndex: 0,
    explanation: "L = Iω = (2I)(ω/2) = Iω. Same. Conservation of angular momentum.",
    improvementTip: "Angular momentum conservation: when no external torque, L = Iω = constant. Ice skater pulling arms in — ω increases as I decreases."
  },
  {
    id: 24,
    subject: "Physics",
    ...
    correctIndex: 0,
    explanation: "Faraday's law: ε = -dΦ/dt (negative sign from Lenz's law - opposes change in flux).",
    improvementTip: "Faraday's law: EMF = -N·dΦ/dt for N turns. The negative sign is Lenz's law. Always include it in equations."
  },
  {
    id: 25,
    subject: "Physics",
    ...
    year: 2022,
    difficulty: "Hard",
    question: "Self-inductance of a solenoid with n turns/meter, length l, area A is:",
    options: ["μ₀n²lA", "μ₀nlA", "μ₀n²A/l", "μ₀nA"],
    correctIndex: 0,
    explanation: "L = μ₀n²V = μ₀n²lA where n = turns per unit length.",
    improvementTip: "Solenoid formulas: B=μ₀nI, L=μ₀n²lA (n=turns/length). Distinguish between N (total turns) and n (turns per length = N/l)."
  },
  {
    id: 26,
    subject: "Physics",
    ...
    correctIndex: 0,
    explanation: "Inside a conductor in electrostatic equilibrium, free charges redistribute so E = 0 inside.",
    improvementTip: "Properties of conductors: E=0 inside, all charge on surface, E perpendicular to surface outside = σ/ε₀."
  },
  {
    id: 27,
    subject: "Physics",
    ...
    year: 2023,
    difficulty: "Hard",
    question: "Capacitance of a parallel plate capacitor with dielectric constant K is:",
    options: ["Kε₀A/d", "ε₀A/Kd", "ε₀A/d", "Kε₀/Ad"],
    correctIndex: 0,
    explanation: "C = Kε₀A/d. Dielectric K increases capacitance by factor K.",
    improvementTip: "Capacitor formulas: C=ε₀A/d (air), C=Kε₀A/d (dielectric). Energy = Q²/2C = CV²/2 = QV/2. All three energy forms appear in CET."
  },
  {
    id: 28,
    subject: "Physics",
    ...
    improvementTip: "YDSE fringe width: β = λD/d. Bright fringe at nλD/d, dark fringe at (2n-1)λD/2d. Draw the setup and label each variable."
  },
  {
    id: 29,
    subject: "Physics",
    ...
    improvementTip: "Brewster's law: tan(iB) = n₂/n₁. At Brewster's angle, reflected light is completely polarized. iB + rB = 90°."
  },
  {
    id: 30,
    subject: "Physics",
    ...
    improvementTip: "Photon energy: E=hν=hc/λ. Momentum p=h/λ=E/c. de Broglie wavelength λ=h/mv. These three are the most tested Modern Physics formulas."
  },
  {
    id: 31,
    subject: "Physics",
    ...
    correctIndex: 0,
    explanation: "Stopping potential depends only on frequency (determines max KE). Intensity affects current but not stopping potential.",
    improvementTip: "Photoelectric effect: frequency determines KE_max and stopping potential; intensity determines photoelectric current (number of electrons)."
  },
  {
    id: 32,
    subject: "Physics",
    ...
    correctIndex: 0,
    explanation: "Isothermal = constant temperature. Adiabatic = no heat exchange. Isobaric = constant pressure.",
    improvementTip: "Thermodynamic processes: Isothermal(T=const), Adiabatic(Q=0), Isobaric(P=const), Isochoric(V=const). Know the PV diagrams for each."
  },
  {
    id: 33,
    subject: "Physics",
    ...
    improvementTip: "Carnot efficiency: η = 1 - T_cold/T_hot (use Kelvin). This is maximum possible efficiency. Real engines are less efficient."
  },
  {
    id: 34,
    subject: "Physics",
    ...
    improvementTip: "Escape velocity = √(2gR) = √(2GM/R) ≈ 11.2 km/s for Earth. Orbital velocity = √(gR) ≈ 7.9 km/s. Escape = √2 × orbital velocity."
  },
  {
    id: 35,
    subject: "Physics",
    ...
    correctIndex: 0,
    explanation: "p-type semiconductor (doped with trivalent atoms like B, Al) has holes as majority carriers.",
    improvementTip: "p-type: majority=holes, minority=electrons (trivalent dopant). n-type: majority=electrons, minority=holes (pentavalent dopant like P, As, Sb)."
  },
  {
    id: 36,
    subject: "Physics",
    ...
    correctIndex: 0,
    explanation: "Torque τ = r × F (cross product of position vector and force). It causes rotational motion.",
    improvementTip: "Torque = r × F = rF sinθ. Maximum torque when θ=90° (force perpendicular to lever arm). Practice with moment problems."
  },
  {
    id: 37,
    subject: "Physics",
    ...
    correctIndex: 0,
    explanation: "Lenz's law (induced current opposes change causing it) is a consequence of conservation of energy.",
    improvementTip: "Lenz's law: induced EMF/current always opposes the change in flux. Use right-hand rule to find direction of induced current."
  },
  {
    id: 38,
    subject: "Physics",
    ...
    correctIndex: 0,
    explanation: "Resolving power ∝ 1/λ. Smaller wavelength → better resolution. This is why electron microscopes are powerful.",
    improvementTip: "Resolving power of microscope = 2n·sinθ/λ. Increases with smaller λ, larger aperture (sinθ), higher n (refractive index of medium)."
  },
  {
    id: 39,
    subject: "Physics",
    ...
    correctIndex: 0,
    explanation: "k = 9×10⁹ Nm²/C². Note: ε₀ = 8.85×10⁻¹² F/m. G = 6.67×10⁻¹¹ (gravitational constant).",
    improvementTip: "Memorize constants: k=9×10⁹, G=6.67×10⁻¹¹, e=1.6×10⁻¹⁹C, h=6.63×10⁻³⁴Js, c=3×10⁸m/s. These appear in every paper."
  },
  {
    id: 40,
    subject: "Physics",
    ...
    year: 2021,
    difficulty: "Hard",
    question: "In Bohr model of hydrogen, radius of nth orbit is proportional to:",
    options: ["n²", "n", "n³", "1/n"],
    correctIndex: 0,
    explanation: "Bohr radius: rₙ = 0.529n² Å. Proportional to n². Energy: Eₙ = -13.6/n² eV.",
    improvementTip: "Bohr model: rₙ ∝ n², vₙ ∝ 1/n, Eₙ ∝ -1/n². For H-atom: r₁=0.529Å, E₁=-13.6eV. These relationships are tested every year."
  },
  // ===== CHEMISTRY =====
  {
    id: 41,
    ...
    correctIndex: 0,
    explanation: "IUPAC: ligands alphabetically (hexaammine) then metal with oxidation state in Roman numerals.",
    improvementTip: "IUPAC coordination: [ligands in alphabetical order + metal(ox. state)]. Ligand names: NH₃=ammine, Cl⁻=chlorido, CN⁻=cyanido, H₂O=aqua. Practice 20 naming problems."
  },
  {
    id: 42,
    subject: "Chemistry",
    ...
    year: 2023,
    difficulty: "Hard",
    question: "Coordination number of Co in [Co(en)₂Cl₂]⁺ is (en = ethylenediamine):",
    options: ["6", "4", "5", "2"],
    correctIndex: 0,
    explanation: "en is bidentate (2 donor atoms). 2 en = 4 bonds + 2 Cl = 6. Coordination number = 6.",
    improvementTip: "Bidentate ligands (en, ox²⁻, acac) contribute 2 to coordination number. Tridentate contribute 3. Always count donor atoms, not number of ligands."
  },
  {
    id: 43,
    subject: "Chemistry",
    ...
    options: ["36", "26", "46", "31"],
    correctIndex: 0,
    explanation: "Fe = 26 electrons. CO donates 2e each × 5 = 10. EAN = 26 + 10 = 36 (Kr configuration).",
    improvementTip: "EAN = atomic number of metal + electrons from ligands. For stable complexes EAN = nearest noble gas (18, 36, 54, 86). Each CO/CN⁻ donates 2e."
  },
  {
    id: 44,
    subject: "Chemistry",
    ...
    correctIndex: 0,
    explanation: "SN2: bimolecular, single step, inversion. Favored by 1° substrate, strong nucleophile, polar aprotic solvent.",
    improvementTip: "SN2 vs SN1: SN2 favors 1° + strong Nu + aprotic solvent (DMSO, acetone). SN1 favors 3° + weak Nu + protic solvent (water, alcohol). Make a comparison table."
  },
  {
    id: 45,
    subject: "Chemistry",
    ...
    year: 2024,
    difficulty: "Medium",
    question: "Which reagent converts alkene to alcohol by anti-Markovnikov addition?",
    options: ["BH₃/THF then H₂O₂/OH⁻", "H₂SO₄/H₂O", "HBr", "Br₂/CCl₄"],
    correctIndex: 0,
    explanation: "Hydroboration-oxidation (BH₃ then H₂O₂/NaOH) gives anti-Markovnikov, syn addition, alcohol.",
    improvementTip: "Hydroboration-oxidation: anti-Markovnikov, syn addition. Oxymercuration-demercuration: Markovnikov, anti addition. Know both mechanisms cold."
  },
  {
    id: 46,
    subject: "Chemistry",
    ...
    correctIndex: 0,
    explanation: "SF₆: S has 6 bond pairs, 0 lone pairs. VSEPR predicts octahedral geometry.",
    improvementTip: "VSEPR shapes: 4 BP=tetrahedral, 3 BP+1 LP=pyramidal, 2 BP+2 LP=bent, 5 BP=trigonal bipyramidal, 6 BP=octahedral. Practice with 20 molecules."
  },
  {
    id: 47,
    subject: "Chemistry",
    ...
    options: ["2", "1", "3", "1.5"],
    correctIndex: 0,
    explanation: "O₂ MO configuration: (σ1s)²(σ*1s)²(σ2s)²(σ*2s)²(σ2p)²(π2p)⁴(π*2p)². BO = (8-4)/2 = 2.",
    improvementTip: "Bond order = (bonding electrons - antibonding electrons)/2. O₂ BO=2 (paramagnetic), N₂ BO=3 (diamagnetic), F₂ BO=1. Know paramagnetism from unpaired e⁻."
  },
  {
    id: 48,
    subject: "Chemistry",
    ...
    year: 2023,
    difficulty: "Medium",
    question: "Standard electrode potential of SHE (Standard Hydrogen Electrode) is:",
    options: ["0 V", "1 V", "-1 V", "0.5 V"],
    correctIndex: 0,
    explanation: "SHE is the reference electrode with E° = 0.00 V by convention.",
    improvementTip: "SHE: E°=0V, H₂ gas at 1 atm, H⁺ at 1M, 25°C. Cell EMF = E°cathode - E°anode. Positive EMF = spontaneous reaction."
  },
  {
    id: 49,
    subject: "Chemistry",
    ...
    year: 2024,
    difficulty: "Hard",
    question: "Faraday's 1st law of electrolysis states that mass deposited is proportional to:",
    options: [
    ...
    correctIndex: 0,
    explanation: "Faraday's 1st law: m = ZQ = ZIt where Z = electrochemical equivalent, Q = charge (coulombs).",
    improvementTip: "Faraday's laws: 1st: m ∝ Q (m=ZIt). 2nd: for same Q, masses ∝ equivalent weights. Faraday constant F = 96500 C/mol."
  },
  {
    id: 50,
    subject: "Chemistry",
    ...
    options: ["F₂", "Cl₂", "Br₂", "I₂"],
    correctIndex: 0,
    explanation: "F₂ is the strongest oxidizing agent. Oxidizing power decreases down the group: F₂>Cl₂>Br₂>I₂.",
    improvementTip: "Halogens: oxidizing power decreases down group (F₂>Cl₂>Br₂>I₂). Reducing power increases down. F₂ can oxidize water itself."
  },
  {
    id: 51,
    subject: "Chemistry",
    ...
    correctIndex: 0,
    explanation: "NO₃⁻: N forms 3 sigma bonds (to 3 O), 0 lone pairs on N → sp² hybridization, trigonal planar.",
    improvementTip: "Hybridization counting: count sigma bonds + lone pairs on central atom. 2=sp, 3=sp², 4=sp³, 5=sp³d, 6=sp³d². Pi bonds don't count."
  },
  {
    id: 52,
    subject: "Chemistry",
    ...
    correctIndex: 0,
    explanation: "Glucose is a reducing sugar (has free aldehyde group). Sucrose is non-reducing (no free anomeric OH).",
    improvementTip: "Reducing sugars have free aldehyde/ketone group. Glucose, fructose, maltose, lactose = reducing. Sucrose = non-reducing (glycosidic bond at both anomeric carbons)."
  },
  {
    id: 53,
    subject: "Chemistry",
    ...
    correctIndex: 0,
    explanation: "Secondary structure (alpha helix, beta sheet) is maintained by hydrogen bonds between peptide linkages.",
    improvementTip: "Protein structure levels: Primary=peptide bonds (sequence), Secondary=H-bonds (helix/sheet), Tertiary=3D folding (all bonds), Quaternary=multiple subunits."
  },
  {
    id: 54,
    subject: "Chemistry",
    ...
    correctIndex: 0,
    explanation: "Nylon-6,6: condensation polymer of hexamethylenediamine (6C) and adipic acid (6C) → 6,6.",
    improvementTip: "Nylon-6,6: diamine + dicarboxylic acid. Nylon-6: ring opening of caprolactam. Dacron: ethylene glycol + terephthalic acid. Bakelite: phenol + formaldehyde."
  },
  {
    id: 55,
    subject: "Chemistry",
    ...
    year: 2022,
    difficulty: "Medium",
    question: "Which colligative property is used to determine molecular mass of polymer?",
    options: [
      "Osmotic pressure",
    ...
    correctIndex: 0,
    explanation: "Osmotic pressure π = MRT is most sensitive for large molecules (polymers) due to measurable π even at low concentration.",
    improvementTip: "Osmotic pressure most sensitive colligative property for high MW substances. All four properties depend on number of solute particles (molality/molarity)."
  },
  {
    id: 56,
    subject: "Chemistry",
    ...
    correctIndex: 0,
    explanation: "d⁶ low spin in octahedral field: CFSE = -2.4Δ₀ (maximum negative value = maximum stabilization).",
    improvementTip: "CFSE calculation: t₂g electrons give -0.4Δ₀ each, eg give +0.6Δ₀ each. Strong field forces pairing. d⁶ low spin = maximum CFSE."
  },
  {
    id: 57,
    subject: "Chemistry",
    ...
    year: 2020,
    difficulty: "Easy",
    question: "Electronegativity difference for ionic bond character should be greater than:",
    options: ["1.7", "0.5", "0", "3.0"],
    correctIndex: 0,
    explanation: "Pauling: EN difference > 1.7 → predominantly ionic (>50% ionic). EN diff < 0.5 → mostly covalent.",
    improvementTip: "Ionic character: EN diff > 1.7 → ionic. 0.5-1.7 → polar covalent. < 0.5 → nonpolar covalent. NaCl EN diff = 2.1 (ionic), HCl = 0.9 (polar covalent)."
  },
  {
    id: 58,
    subject: "Chemistry",
    ...
    year: 2025,
    difficulty: "Hard",
    question: "Markovnikov's rule: in HX addition to alkene, H adds to carbon with:",
    options: ["More H atoms", "Less H atoms", "Equal H atoms", "No H atoms"],
    correctIndex: 0,
    explanation: "Markovnikov's rule: H adds to carbon that already has more H (most substituted halide forms). Based on carbocation stability.",
    improvementTip: "Markovnikov's rule: H⁺ adds to less substituted C, X⁻ adds to more substituted C. Explained by stability of carbocation intermediates: 3°>2°>1°>methyl."
  },
  {
    id: 59,
    subject: "Chemistry",
    ...
    correctIndex: 0,
    explanation: "RT/F = (8.314×298)/96500 = 0.0257 V. For log₁₀: E = E° - (0.0592/n)logQ.",
    improvementTip: "Nernst equation: E = E° - (0.0592/n)log Q at 25°C (using log₁₀). Memorize 0.0592 for MHT-CET calculations. Q = products/reactants from balanced equation."
  },
  {
    id: 60,
    subject: "Chemistry",
    ...
    year: 2020,
    difficulty: "Medium",
    question: "PCl₅ can act as both Lewis acid and base because phosphorus has:",
    options: [
      "Empty d orbitals",
      "Empty p orbitals",
      "Lone pairs only",
    ...
    correctIndex: 0,
    explanation: "P has empty 3d orbitals that can accept electron pairs (Lewis acid). Lone pairs on Cl can donate (Lewis base character).",
    improvementTip: "Elements with empty d orbitals (P, S, Cl in period 3+) can expand octet and act as Lewis acids. N, O, F cannot expand octet (no d orbitals in period 2)."
  }
];
...
const getYearFrequency = (subject) => {
  const years = [2020, 2021, 2022, 2023, 2024, 2025];
  return years.map((year) => ({
    year,
    count: questions.filter((q) => q.subject === subject && q.year === year).length
  }));
};
const getChapterFrequency = (subject) => {
  ...
  return chapters.map((chapter) => ({
    ...
    years: [
      ...new Set(
        questions.filter((q) => q.subject === subject && q.chapter === chapter).map((q) => q.year)
      )
    ].sort()
  })).sort((a, b) => b.count - a.count);
};
function PYQAnalyticsPage({ theme, onNavigate }) {
  const [subject, setSubject] = reactExports.useState("Maths");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Navbar, { theme, onNavigate, active: "pyq-analytics" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto px-6 py-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-4xl font-black mb-2", style: { color: "#F4F7FF" }, children: "PYQ Analytics" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mb-8", style: { color: "#AAB3C5" }, children: "Frequency analysis of MHT-CET questions from 2020–2025." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-3 mb-10", children: ["Maths", "Physics", "Chemistry"].map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
          ...
          style: {
            background: subject === s ? `linear-gradient(135deg, ${subjectColors[s]}, ${theme.secondary})` : "rgba(255,255,255,0.07)",
            color: subject === s ? "#000" : "#F4F7FF",
            border: subject === s ? "none" : "1px solid rgba(255,255,255,0.12)",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-3xl p-8 mb-8", style: glass, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-xl font-black mb-6", style: { color: "#F4F7FF" }, children: [
          "Year-wise Question Frequency (",
          subject,
          ")"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-end gap-4 h-48", children: yearData.map((d) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs", style: { color: "#AAB3C5" }, children: d.year })
            ]
          },
          d.year
        )) })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-3xl p-8 mb-8", style: glass, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-black mb-6", style: { color: "#F4F7FF" }, children: "Chapter-wise Weightage" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: chapterData.map((c, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
                  ...
                  style: {
                    background: i < 3 ? subjectColors[subject] : "rgba(255,255,255,0.1)",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-1", children: [
                  ...
                  c.count >= 3 && /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "span",
                    {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-1 mt-1", children: c.years.map((y) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
...
function ResultsPage({ theme, result, onNavigate }) {
  const [showReview, setShowReview] = reactExports.useState(false);
  const { questions: questions2, answers, timeTaken } = result;
  const correct = answers.filter(
    (a, i) => a === questions2[i].correctIndex
  ).length;
  const wrong = answers.filter(
    (a, i) => a !== null && a !== questions2[i].correctIndex
  ).length;
  const skipped = answers.filter((a) => a === null).length;
  const pct = Math.round(correct / questions2.length * 100);
  ...
  for (let i = 0; i < answers.length; i++) {
    const a = answers[i];
    if (a !== null && a !== questions2[i].correctIndex) {
      const ch = questions2[i].chapter;
      if (!wrongByChapter[ch])
        wrongByChapter[ch] = {
          count: 0,
          tips: [],
          subject: questions2[i].subject
        };
      wrongByChapter[ch].count++;
      if (!wrongByChapter[ch].tips.includes(questions2[i].improvementTip)) {
        wrongByChapter[ch].tips.push(questions2[i].improvementTip);
      }
    }
  }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Navbar, { theme, onNavigate }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto px-6 py-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-7xl mb-4", children: grade.emoji }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  correct,
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-4xl", style: { color: "#AAB3C5" }, children: [
                    "/",
                    questions2.length
                  ] })
                ]
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-4 mb-8", children: [
        ...
        "div",
        {
          ...
          style: glass,
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-3xl font-black", style: { color: s.color }, children: s.val }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
      ...
      weakChapters.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "h2",
              {
                ...
                style: { color: "#F4F7FF" },
                children: "📋 Your Personalized Study Plan"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm mb-6", style: { color: "#AAB3C5" }, children: "Based on your wrong answers, here's exactly what to focus on:" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-bold", style: { color: theme.primary }, children: "Recommended Daily Study Time" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm", style: { color: "#AAB3C5" }, children: getStudyTime(pct) })
                  ] })
                ]
              }
            ),
            top3.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-6", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "h3",
                {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: top3.map(([chapter, data], i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-2", children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                        data.count >= 2 && /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "span",
                          {
                            className: "text-xs px-2 py-0.5 rounded-full font-bold",
                            style: {
            ...
            weakChapters.length > 3 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "h3",
                {
                  className: "text-sm font-black mb-3",
                  style: { color: "#AAB3C5" },
                  children: "ALSO REVISE"
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2", children: weakChapters.slice(3).map(([chapter, data]) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "span",
                {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "h2",
              {
                ...
                style: { color: "#22E648" },
                children: "Perfect or Near-Perfect Score!"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { color: "#AAB3C5" }, children: "Keep maintaining this level. Try a harder difficulty or mixed subject test next!" })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-3xl p-8 mb-8", style: glass, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-black mb-4", style: { color: "#F4F7FF" }, children: "💡 General Tips to Improve" }),
        ...
        ].map(({ icon, tip }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-lg mt-0.5", children: icon }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm", style: { color: "#AAB3C5" }, children: tip })
        ] }, tip)) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "📝 Review All Questions" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: theme.primary }, children: showReview ? "▲ Hide" : "▼ Show" })
                ]
              }
            ),
                  ...
                  return /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      ...
                      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xl mt-0.5", children: statusIcon }),
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-1 mb-3", children: q.options.map((opt, oi) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                            "div",
                            {
                              className: "text-xs px-3 py-1.5 rounded-xl",
                              style: {
                                background: oi === q.correctIndex ? "#22E64822" : userAns === oi && !isCorrect ? "#FF4F4F22" : "transparent",
                                color: oi === q.correctIndex ? "#22E648" : userAns === oi && !isCorrect ? "#FF4F4F" : "#AAB3C5",
                                border: oi === q.correctIndex ? "1px solid #22E64844" : "none"
                              },
                              children: [
                                ...
                                opt,
                                oi === q.correctIndex && " ✓",
                                userAns === oi && !isCorrect && " ✗ (your answer)"
                              ]
                            },
                            `${q.id}-opt-${oi}`
                          )) }),
                          !isCorrect && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsxs(
                              "p",
                              {
                            ...
                            /* @__PURE__ */ jsxRuntimeExports.jsxs(
                              "p",
                              {
                                ...
                                children: [
                                  "🎯 ",
                                  /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "How to improve:" }),
                                  " ",
                                  q.improvementTip
                                ]
                              }
...
function SubjectsPage({ theme, onNavigate }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Navbar, { theme, onNavigate, active: "subjects" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto px-6 py-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-4xl font-black mb-2", style: { color: "#F4F7FF" }, children: "Subjects" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mb-10", style: { color: "#AAB3C5" }, children: "Explore chapters and question distribution for each subject." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-6", children: subjects.map((s) => {
            ...
            children: [
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-left", children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm", style: { color: "#AAB3C5" }, children: s.desc })
                      ] })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: s.color, fontSize: "1.5rem" }, children: isOpen ? "▲" : "▼" })
                  ]
                }
              ),
              isOpen && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-2 gap-3", children: chapters.map((c, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "div",
                      {
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx(
                              "span",
                              {
                                ...
                                style: {
                                  background: i < 3 ? s.color : "rgba(255,255,255,0.1)",
                                  color: i < 3 ? "#000" : "#AAB3C5"
                                },
                                children: i + 1
                              }
...
function TestPage({ theme, config, onFinish }) {
  const [testQs] = reactExports.useState(() => {
    let pool = config.subject === "Mixed" ? questions : questions.filter((q2) => q2.subject === config.subject);
    if (config.difficulty !== "All")
      pool = pool.filter((q2) => q2.difficulty === config.difficulty);
  ...
  const submitTest = reactExports.useCallback(() => {
  ...
  const optionStyle = (idx) => {
    ...
    return {
      ...
      border: isSelected ? `2px solid ${theme.primary}` : "2px solid rgba(255,255,255,0.1)",
      color: "#F4F7FF",
      boxShadow: isSelected ? `0 0 15px ${theme.glow}` : "none"
    };
  };
  const unanswered = answers.filter((a) => a === null).length;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex flex-col", style: { color: "#F4F7FF" }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "font-bold text-sm", style: { color: theme.primary }, children: [
            "Q ",
            current + 1,
            " / ",
            testQs.length
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 mx-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "font-mono font-bold", style: { color: "#AAB3C5" }, children: [
            "⏱ ",
            formatTime(seconds)
          ] })
        ]
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 max-w-3xl mx-auto w-full px-6 py-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 mb-6 flex-wrap", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "span",
          {
            className: "px-3 py-1 rounded-full text-xs font-bold",
            style: {
              background: q.difficulty === "Hard" ? "#ff4f4f22" : q.difficulty === "Medium" ? "#ffaa0022" : "#22e64822",
              color: q.difficulty === "Hard" ? "#ff4f4f" : q.difficulty === "Medium" ? "#ffaa00" : "#22e648"
            },
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg font-medium leading-relaxed", children: q.question })
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3 mb-8", children: q.options.map((opt, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          type: "button",
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
                ...
                style: {
                  background: selected === idx ? theme.primary : "rgba(255,255,255,0.1)",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center", children: [
        ...
        current < testQs.length - 1 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-center mt-6 text-sm", style: { color: "#AAB3C5" }, children: [
      ...
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-black mb-2", children: "Submit Test?" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mb-6 text-sm", style: { color: "#AAB3C5" }, children: unanswered > 0 ? `You have ${unanswered} unanswered questions.` : "All questions answered!" }),
...
function TestSetupPage({ theme, onNavigate, onStart }) {
  const [subject, setSubject] = reactExports.useState("Maths");
  ...
  const pill = (active, color) => ({
    background: active ? `linear-gradient(135deg, ${color}, ${theme.secondary})` : "rgba(255,255,255,0.07)",
    border: active ? "none" : "1px solid rgba(255,255,255,0.12)",
    color: active ? "#000" : "#F4F7FF",
    boxShadow: active ? `0 0 20px ${theme.glow}` : "none"
  });
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Navbar, { theme, onNavigate, active: "test-setup" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl mx-auto px-6 py-16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-4xl font-black mb-2", style: { color: "#F4F7FF" }, children: "Configure Your Test" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mb-10", style: { color: "#AAB3C5" }, children: "Set up a personalized mock test based on PYQ patterns." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-8", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-3", children: subjects.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  type: "button",
                  onClick: () => setSubject(s),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-8", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-3", children: counts.map((c) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  type: "button",
                  onClick: () => setCount(c),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-10", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-3", children: difficulties.map((d) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  type: "button",
...
function App() {
  ...
  const [testConfig, setTestConfig] = reactExports.useState(null);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        view === "subjects" && /* @__PURE__ */ jsxRuntimeExports.jsx(SubjectsPage, { theme, onNavigate: goTo }),
        view === "test-setup" && /* @__PURE__ */ jsxRuntimeExports.jsx(TestSetupPage, { theme, onNavigate: goTo, onStart: startTest }),
        view === "test" && testConfig && /* @__PURE__ */ jsxRuntimeExports.jsx(
          TestPage,
          {
            theme,
            config: testConfig,
        ...
        view === "results" && testResult && /* @__PURE__ */ jsxRuntimeExports.jsx(ResultsPage, { theme, result: testResult, onNavigate: goTo }),
        view === "pyq-analytics" && /* @__PURE__ */ jsxRuntimeExports.jsx(PYQAnalyticsPage, { theme, onNavigate: goTo })
      ]
    }
  );
}
